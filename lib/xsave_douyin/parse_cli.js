...
function build_help_text(script_name) {
  ...
  return [
    ...
    "  -p, --path <dir>             Output root (default: f2 douyin/<mode> library)",
    ...
    "      --check-all              Scan the entire list instead of stopping at already downloaded items (default: false)",
    ...
    "  $0 --check-all -M like -u https://v.douyin.com/kIg44MNOKz8/",
    "",
...
function parse_cli(argv) {
  ...
  return {
    ...
    check_all: Boolean(parsed["check-all"]),
