...
const { resolve_alias_target } = require("./addressable");
...
function resolve_addressable_alias_target(index, alias_entry, options = {}) {
  return resolve_alias_target(index, alias_entry, options);
}
...
module.exports = {
  ...
  resolve_addressable_alias_target,
