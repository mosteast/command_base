...
function assert_current_target(context, target, label = "Structural edit") {
  if (
    ...
    typeof context.index.source.source_identity !== "string" ||
  ...
  if (
    ...
    typeof target.source_identity !== "string" ||
  ...
  const source_identity = context.index.source.source_identity;
  ...
  if (
    ...
    target.source_identity !== source_identity ||
